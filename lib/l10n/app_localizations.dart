...
abstract class AppLocalizations {
  ...
  /// No description provided for @signupSuccessLoginPrompt.
  ///
  /// In en, this message translates to:
  /// **'Signup successful! Please login.'**
  String get signupSuccessLoginPrompt;
  ...
  /// No description provided for @orderNotificationsDesc.
  ///
  /// In en, this message translates to:
  /// **'Get notified when an order is placed successfully'**
  String get orderNotificationsDesc;
  ...
  /// No description provided for @phoneNumberOptionalHint.
  ///
  /// In en, this message translates to:
  /// **'Optional'**
  String get phoneNumberOptionalHint;
  ...
  /// No description provided for @acrossTop.
  ///
  /// In en, this message translates to:
  /// **'Up to 70% off across top categories'**
  String get acrossTop;
  ...
  /// No description provided for @highly.
  ///
  /// In en, this message translates to:
  /// **'Handpicked,highly rated by shoppers'**
  String get highly;
}
